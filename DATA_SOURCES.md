...
5. Basrur NS et al. (2020). *Fruitless mutant male mosquitoes gain attraction to human odor.* eLife 9:e63982. DOI: [10.7554/eLife.63982](https://doi.org/10.7554/eLife.63982). Its Aedes measurements reuse Matthews RNA-seq, [PRJNA236239](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA236239), already represented by our **Neurotranscriptome (reprocessed)** gene-TPM matrix. The catalog cites Basrur with that dataset; it does not duplicate the samples as another study. The paper's new [PRJNA612100](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA612100) raw brain reads are from other mosquito species. The Figure 1 exon-count table is not imported into the app.
