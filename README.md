...
- Compare every gene between two conditions with an MA plot of average TPM versus log₂ ratio, FDR-driven opacity, TPM summaries, Welch p-values, and Benjamini–Hochberg FDR.
